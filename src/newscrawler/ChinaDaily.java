...
//            System.out.println(htmlDocument.html());
            ...
            Elements linksOnPage = htmlDocument.select("ul.cs_sear_list").select("li");
...
//             System.out.println;
            // get news
             String news = htmlDocument.select("div#Content").text();
//             System.out.println(news);
             
             //get title
             String title = htmlDocument.select("h1").text();
//             System.out.println(title);
             
//             //get date
             
             String date = htmlDocument.select("span.info_l").text();
